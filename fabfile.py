...
def install():
    ...
    local('cp bower_components/trumbowyg/dist/ui/images/icons-black-2x.png web/css/images/')
    local('cp bower_components/trumbowyg/dist/ui/images/icons-black.png web/css/images/')
    local('cp bower_components/trumbowyg/dist/ui/images/icons-white-2x.png web/css/images/')
    local('cp bower_components/trumbowyg/dist/ui/images/icons-white.png web/css/images/')
    ...
    local('cp bower_components/trumbowyg/dist/ui/trumbowyg.min.css web/css/')
    ...
    local('cp bower_components/trumbowyg/dist/trumbowyg.min.js web/js/')
    local('cp bower_components/trumbowyg/dist/langs/fr.min.js web/js/lang/')
